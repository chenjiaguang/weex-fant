  ...
  <div class="wxc-tab-page"
    ...
    <scroller class="tab-title-list"
      ...
      <div class="title-item"
        ...
        <text
          v-if="!titleUseSlot"
          :style="{ fontSize: tabStyles.fontSize+'px',
          ...
          lineHeight:tabStyles.height+'px'}"
          class="tab-text">{{v.title}}</text>
        <div class="border-bottom"
             v-if="tabStyles.hasActiveBottom && !titleUseSlot"
             :style="{ width: tabStyles.activeBottomWidth+'px', height: tabStyles.activeBottomHeight+'px',marginTop:-tabStyles.activeBottomHeight+'px', backgroundColor: currentPage === index ? tabStyles.activeBottomColor : 'transparent' }"></div>
