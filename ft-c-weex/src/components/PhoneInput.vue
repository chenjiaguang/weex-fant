<template>
  <div class="box-wrapper">
    ...
    <input :maxlength="11" class="input" type="tel" :placeholder="placeholder" v-model="phone.value" @input="onInput" @change="onChange" />
    <div class="clear-wrapper">
      <div v-if="phone.value" class="clear-btn" @click="onClear">
...
<script>
  export default {
    props: ['phone', 'prefix', 'placeholder', 'inputHandler', 'changeHandler'],
    data () {
      return {
